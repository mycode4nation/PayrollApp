...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h5 class="card-title m-0">Data Pola Kerja Kelompok Kerja</h5>
        </div>
        <div class="card-body">
            @include('alert')
            <div class="row">
                <div class="col-md-5">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                                    <td></td>
                                    <td><button type="submit" class="btn btn-warning">Simpan</button>
                                        <a href="/kelompokKerja" class="btn btn-success">Kembali</a>    
                                    </td>
                                </tr>
                    </table>
                    {{ Form::close()}}
